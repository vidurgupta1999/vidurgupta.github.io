const greeting = {
    ...
    Data_Analytics: true,  // if true, Show 'Full Stack Development' section in home page, if false than not show
    UIUX_Design: true,  // if true, Show 'designer' section in home page, if false than not show
    da:false,  // if true, Show 'cloud_infra_architecture' section in home page, if false than not show
...
const BlogData = {
    ...
    Blog_Bio : [
        ...
        "I have always had a passion for UX/Ui Design."
    ]
};
